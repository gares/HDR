...
In this chapter we survey some tools developed on top of Rocq-Elpi or Elpi alone.

We put forward the Derive and Hierarchy-Builder Rocq packages
to which we contributed personally.

Later we quickly survey other tools developed by our colleagues, some of which
do not use Rocq.
