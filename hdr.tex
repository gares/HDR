...
problem (the goal) to simpler ones. Operationally, the head is unified~\cite{10.1145/321250.321253}
with
...
goal. The following snippet depicts how to run a query, in particular
...
the term \elpi{(x\ lam y\ x)} is an Elpi function of \elpi{x}. Note that
