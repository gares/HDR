...
extent, theorems.
Maybe the most shiny example of this approach is Iris~\cite{10.1007/978-3-662-54434-1_26}.
Iris is a separation logic
that is proved sound in Rocq, that thanks to its proof mode~\cite{IPM} it
...
(immutable) lists made of cons and nil, and imperative algorithms to their
functional specification, the same specification other...

VST~\cite{VST}, FOL~\cite{FOL},

what is the role of Elpi in such a future. surely can stay as EL.
If one goes in the direction of~\cite{concon} it may serve as the missing
code
