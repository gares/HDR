...
purpose -- or example, the function space is not ideal for an HOAS encoding of
...
developers could
take a step back and attempt to retrofit a logical framework in CIC, inspired
