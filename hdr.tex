...
it has a constant memory overhead. Most of the time, one fires all redexes in
one go and immediately needs to inspect the result.
...
Sacerdoti Coen and Cvetan Dunchev around 2015 and is described in~\cite{dunchev15lpar}.
