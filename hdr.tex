...
Rules added via implication are called dynamic, or hypothetical.
Variables bounds by \elpi{pi} are said to be bound by the program,
or by the $\lambda$Prolog context.
